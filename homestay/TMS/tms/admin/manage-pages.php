...
<html>
<head>
<title>TMS | Cập nhật trang</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Cập nhật dữ liệu trang </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Cập nhật trang</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="" selected="selected" class="form-control">Danh sách trang</option>
                  <option value="manage-pages.php?type=terms">Điều khiển và điều kiện</option>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Chi tiết trang</label>
									<div class="col-sm-8">
									<?php
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Mô tả chi tiết</label>
									<div class="col-sm-8">
