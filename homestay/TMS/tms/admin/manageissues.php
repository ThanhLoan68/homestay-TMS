...
<html>
<head>
<title>TMS | Quản lý sự cố thông tin người dùng</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Quản lý sự cố thông tin người dùng</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Danh sách Quản lý sự cố thông tin người dùng </h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>STT</th>
