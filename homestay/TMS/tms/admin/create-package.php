...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Tải ảnh</label>
									<div class="col-sm-8">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn">Tạo phòng</button>
